...
class ExperimentRunner:
    ...
    def run_cross_validation_experiment(
        ...
        for fold_idx, (train_loader, test_data) in enumerate(
                zip(train_val_loader, test_loader)):
            ...
            train_data, valid_data, fold_scalers = train_loader
            np.savez(os.path.join(save_path, f"fold_scalers_{str(fold_number)}.npz"),
                     fold_scaler=fold_scalers)
...
if __name__ == "__main__":
    ...
    dataset_path = "TIMESERIES/ETTH1_96_TIMESTEPS_AHEAD_HORIZON_720/"
